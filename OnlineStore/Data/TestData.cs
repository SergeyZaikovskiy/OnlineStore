...
#region Катерогии одежды
            ...
            new CategoryToBrand{id=40, CategoryId = 4 , BrandId=25},

            new CategoryToBrand{id=41, CategoryId = 5 , BrandId=16},
            new CategoryToBrand{id=42, CategoryId = 5 , BrandId=17},
            new CategoryToBrand{id=43, CategoryId = 5 , BrandId=18},
            new CategoryToBrand{id=44, CategoryId = 5 , BrandId=19},
            new CategoryToBrand{id=45, CategoryId = 5 , BrandId=20},
            new CategoryToBrand{id=46, CategoryId = 5 , BrandId=21},
            new CategoryToBrand{id=47, CategoryId = 5 , BrandId=22},
            new CategoryToBrand{id=48, CategoryId = 5 , BrandId=23},
            new CategoryToBrand{id=49, CategoryId = 5 , BrandId=24},
            new CategoryToBrand{id=50, CategoryId = 5 , BrandId=25},
...
#region Категории аксессуаров
        ...
        public static List<Product> Products { get; } = new List<Product>
        {
            ...
            new Product { id = 19, Name = "Футболка", Price = 800, FileId = 1, Order = 7, SectionId = 2, BrandId = 12 , CategoryId = 6},
