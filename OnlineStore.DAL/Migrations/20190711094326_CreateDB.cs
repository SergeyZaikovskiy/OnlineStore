    ...
    public partial class CreateDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryToBrand", x => new { x.CategoryId, x.BrandId });
                    table.UniqueConstraint("AK_CategoryToBrand_id", x => x.id);
                    table.ForeignKey(
                        name: "FK_CategoryToBrand_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryToBrand_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SectionToCategory", x => new { x.SectionId, x.CategoryId });
                    table.UniqueConstraint("AK_SectionToCategory_id", x => x.id);
                    table.ForeignKey(
                        name: "FK_SectionToCategory_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SectionToCategory_Sections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "Sections",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryToBrand_BrandId",
                table: "CategoryToBrand",
                column: "BrandId");
